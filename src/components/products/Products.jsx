...
export default function Products() {
  return (
    <div className="products-componant">
      <div className="up">
        <h1>|PROPRIES</h1>
        <h2>
          We Provide The <br /> Best Proprty <br /> You Like
        </h2>
      </div>
      <div className="down">
        <div className="card">
          ...
          <div className="card-center">
            ...
            <div className="card-center-center">
              <h4>18 New Street Miame, OR 97219</h4>
            </div>
            <div className="card-center-down">
              <p>
                Bedrooms: <b>8</b>
              </p>
              <p>
        ...
        <div className="card">
          <div className="card-up">
            <img src="/images/property-03.jpg" alt="" />
          </div>
          <div className="card-center">
            <div className="card-center-up">
              <a href="">Luxury Villa</a>
